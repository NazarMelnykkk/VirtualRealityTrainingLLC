...
public class DistanceCounter : MonoBehaviour
{
    ...
    [SerializeField] private ViewCarDistanceController _viewCarDistanceController;
    ...
    private void FindNearestCar()
    {
        ...
        if (_nearestCar != null)
        {
            _viewCarDistanceController.SetDistanceValue(shortestDistance.ToString("F1") + " meters");
        }
        else
        {
            _viewCarDistanceController.SetDistanceValue(null);
        }
    }
